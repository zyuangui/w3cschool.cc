...
<html>
  ...
  <body
   style="background:url(image/studentBackground1.jpg) no-repeat; background-color:#eaf1fd;">
  ...
  <jsp:include page="/stu_jsp/stuHomeHead.jsp"/>
    ...
    <div class="body">
       ...
       <div class="body-left">
           	<ul>
	            	<li><a class="Home" href="stu_jsp/stuHomepage.jsp"><img src="image/iconfont-shouyeshouye.png" width="15px" height="15px">&nbsp;&nbsp;个人首页</a></li>
	                <li><a href="FindStuInfoAction"><img src="image/iconfont-gerenxinxi.png" width="15px" height="15px">&nbsp;&nbsp;个人资料</a></li>
	                <li><a href="UpdateStuInfoServlet"><img src="image/iconfont-gerenxinxi.png" width="15px" height="15px">&nbsp;&nbsp;修改信息</a></li>
	                <li><a href="stuPostServlet?stuId=${stu.stu_Id }&stuName=${stu.stu_Name}"><img src="image/iconfont-fatie.png" width="15px" height="15px">&nbsp;&nbsp;我的帖子</a></li>
	                <li><a href="#"><img src="image/iconfont-weiduhuitie.png" width="15px" height="15px">&nbsp;&nbsp;我的回帖</a></li>
	                <li><a href="#"><img src="image/iconfont-zuoyeicon.png" width="15px" height="15px">&nbsp;&nbsp;我的作业</a></li>
	                <li><a href="#"><img src="image/iconfont-wenda.png" width="15px" height="15px">&nbsp;&nbsp;我的问答</a></li>
